...
class BabiesControllerTest < ActionController::TestCase
  ...
  test "should create baby" do
    assert_difference('Baby.count') do
      post :create, baby: { age: @baby.age, height: @baby.height, name: @baby.name, weight: @baby.weight }
    end
  ...
  test "should update baby" do
    patch :update, id: @baby, baby: { age: @baby.age, height: @baby.height, name: @baby.name, weight: @baby.weight }
    assert_redirected_to baby_path(assigns(:baby))
  end
